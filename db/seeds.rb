...
monster = Monster.find_or_create_by!(name: "イャンガルルガ")
...
puts "ドスゲネポスの肉質データを登録しました！"
puts "ドスランポスの肉質データを登録しました！"
...
# ゲリョス亜種
monster = Monster.find_by!(name: "ゲリョス亜種")
...
variant = monster.monster_variants.find_or_create_by!(name: "奇種")
...
monster = Monster.find_by!(name: "ドスゲネポス")
...
monster = Monster.find_by!(name: "ドスランポス")
